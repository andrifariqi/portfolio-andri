        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-xl">
            ...
            <a href="mailto:andrialfariqiid@gmail.com">
              <div className="radial-progress bg-primary text-primary-content border-4 border-primary mx-3 my-3 hover:bg-orange-300 hover:animate-ping" style={{ "--value": 100 }} data-aos="flip-left" data-aos-duration="1000" data-aos-easing="linear">
            ...
            <a href="https://github.com/andrifariqi">
              <div className="radial-progress bg-primary text-primary-content border-4 border-primary mx-3 my-3 hover:bg-orange-300 hover:animate-ping" style={{ "--value": 100 }} data-aos="flip-down" data-aos-duration="1000" data-aos-easing="linear">
                <Image src={GithubImage} height={40} width={40} alt="GithubImage" />
              </div>
            </a>

            <a href="https://www.linkedin.com/in/andri-a-261085217/">
              <div className="radial-progress bg-primary text-primary-content border-4 border-primary mx-3 my-3 hover:bg-orange-300 hover:animate-ping" style={{ "--value": 100 }} data-aos="flip-right" data-aos-duration="1000" data-aos-easing="linear">
